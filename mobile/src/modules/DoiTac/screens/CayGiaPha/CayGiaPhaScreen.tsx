...
import { layThanhVien } from "../../services/cayGiaPhaService";
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: "#FFF8F2", // Nền cam sáng nhẹ tinh tế đồng bộ
  },
  ...
  header: {
    ...
    backgroundColor: "#ffffff", // Trắng vương giả thanh lịch
  ...
  title: {
    color: "#0F172A", // Chữ tối thẫm cực kỳ sang trọng
    fontSize: 26,
    fontWeight: "900",
    letterSpacing: 0.8,
  },
