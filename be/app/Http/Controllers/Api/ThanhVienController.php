...

{
    ...
    public function traCuuQuanHe(Request $request, RelationshipService $relationshipService)
    {
        try {
            ...
            // Tính toán cách xưng hô (conversational term của nguoi2 đối với nguoi1)
            $termBToA = $relationshipService->resolve($nguoi2, $nguoi1) ?? 'quan hệ';
            $appellation = $relationshipService->getConversationalTerm($termBToA);
            ...
            return response()->json([
                ...
                'appellation' => $appellation, // Cách nguoi1 gọi nguoi2
