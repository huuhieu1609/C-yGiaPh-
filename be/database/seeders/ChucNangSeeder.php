...
class ChucNangSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['ten_chuc_nang' => 'Quản Lý Dòng Họ', 'ten_slug' => 'quan-ly-dong-ho', 'url' => '/quan-ly-dong-ho', 'mo_ta' => 'Quản lý dòng họ và thành viên'],
            ['ten_chuc_nang' => 'Quản Lý Chi Nhánh', 'ten_slug' => 'quan-ly-chi-nhanh', 'url' => '/chi-nhanh', 'mo_ta' => 'Quản lý chi nhánh dòng họ'],
            ['ten_chuc_nang' => 'Quản Lý Đời Tộc Họ', 'ten_slug' => 'quan-ly-doi-toc-ho', 'url' => '/doi-toc-ho', 'mo_ta' => 'Quản lý các đời tộc họ'],
            ['ten_chuc_nang' => 'Quản Lý Nhà Thờ Họ', 'ten_slug' => 'quan-ly-nha-tho-ho', 'url' => '/nha-tho-ho', 'mo_ta' => 'Quản lý thông tin nhà thờ họ'],
            ['ten_chuc_nang' => 'Quản Lý Mộ Phần', 'ten_slug' => 'quan-ly-mo-phan', 'url' => '/mo-phan', 'mo_ta' => 'Quản lý mộ phần, bản đồ số'],
            ['ten_chuc_nang' => 'Quỹ & Sự Kiện', 'ten_slug' => 'quy-va-su-kien', 'url' => '/quy-va-su-kien', 'mo_ta' => 'Quản lý quỹ đóng góp và sự kiện'],
            ...
            ['ten_chuc_nang' => 'Quản Lý Đóng Góp', 'ten_slug' => 'quan-ly-dong-gop', 'url' => '/dong-gop', 'mo_ta' => 'Quản lý các khoản đóng góp quỹ dòng họ'],
