...
class MoPhanSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($thanhViens as $idx => $memberId) {
            ...
            // Logic tính toán offset rải đều tọa độ vệ tinh 
            $latOff = (($idx % 5) - 2) * 0.00005 + intdiv($idx, 5) * 0.00008;
            $lngOff = (($idx % 4) - 2) * 0.00005 + intdiv($idx, 4) * 0.00008;
            ...
            DB::table('mo_phans')->updateOrInsert(
                ...
                [
                    ...
                    'vi_do'           => (string) number_format($nt['center_lat'] + $latOff, 7, '.', ''),
                    'kinh_do'         => (string) number_format($nt['center_lng'] + $lngOff, 7, '.', ''),
                    'hinh_anh'        => null,
