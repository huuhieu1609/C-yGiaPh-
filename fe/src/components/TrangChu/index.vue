    ...
    <div class="container-custom content-relative pt-5">
      ...
      <section class="features-section mt-5">
        ...
        <div class="grid-3-cols">
          <div class="glass-feature-card">
            ...
            <p class="text-white-50 mt-3">Chuyển đổi những cuốn sổ cũ kỹ thành cây gia phả số hóa sống động, dễ dàng
              truy cập và bảo mật vĩnh viễn.</p>
          </div>
          ...
          <div class="glass-feature-card">
            ...
            <p class="text-white-50 mt-3">Hướng dẫn chi tiết cách gọi tên, xưng danh vị trí chính xác của từng cá nhân
              trong dòng họ nội ngoại.</p>
          </div>
          ...
          <div class="glass-feature-card">
            ...
            <p class="text-white-50 mt-3">Nơi lưu giữ những câu chuyện, video và hình ảnh chưa từng kể về những người đã
              khuất.</p>
          </div>
        </div>
      </section>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-6">
              <div class="ps-lg-5 mt-4 mt-lg-0">
                ...
                <p class="text-white-50 mb-4 lh-lg">Khoảnh khắc thắp nén nhang cho tổ tiên là lúc sợi dây truyền thống
                  rạng lên mạnh mẽ nhất. Heritage Archivist giúp bạn thấu hiểu hơn về cội nguồn, để mỗi nén nhang thắp
                  lên là một sự kết nối tâm hồn trọn vẹn.</p>
        ...
        <div class="row g-4 justify-content-center">
          ...
          <div class="col-md-4">
            <div class="process-step-card text-center p-5">
              ...
              <p class="text-white-50 mt-3">Mời người thân cùng tham gia đóng góp và chiêm ngưỡng cây gia phả trực
                tuyến.</p>
            </div>
          </div>
        </div>
      ...
      <section class="testimonials-section mt-5 pt-5 pb-5">
        ...
        <div class="grid-3-cols">
          <div class="glass-testimonial-card p-4 border border-white/10 rounded-3xl">
            ...
            <p class="text-white-50 fst-italic mb-4">"Ứng dụng này đã giúp dòng họ chúng tôi kết nối lại với nhau sau
              nhiều năm thất lạc thông tin. Cảm ơn đội ngũ phát triển vì một sản phẩm quá ý nghĩa!"</p>
          ...
          <div class="glass-testimonial-card p-4 border border-white/10 rounded-3xl">
            <div class="quote-icon mb-3"><i class="bx bxs-quote-left text-gold fs-1 opacity-25"></i></div>
            <p class="text-white-50 fst-italic mb-4">"Giao diện hiện đại nhưng vẫn giữ được nét truyền thống. Việc tra
              cứu và quản lý thành viên trở nên vô cùng đơn giản so với ghi chép sổ tay."</p>
            <div class="author-meta d-flex align-items-center">
          ...
          <div class="glass-testimonial-card p-4 border border-white/10 rounded-3xl">
            <div class="quote-icon mb-3"><i class="bx bxs-quote-left text-gold fs-1 opacity-25"></i></div>
            <p class="text-white-50 fst-italic mb-4">"Tính năng lưu trữ hình ảnh và video là thứ tôi thích nhất. Những
              thước phim về ông bà giờ đây được lưu giữ vĩnh viễn cho con cháu đời sau."</p>
            <div class="author-meta d-flex align-items-center">
      ...
      <section class="footer-cta text-center mt-5 pb-5">
        <div class="glass-info p-5 rounded-3xl border border-white/10">
          ...
          <button class="btn btn-gradient-home px-5 py-3" @click="$router.push('/register')">ĐĂNG KÝ TÀI KHOẢN MIỄN
            PHÍ</button>
        </div>
      </section>
    </div>
