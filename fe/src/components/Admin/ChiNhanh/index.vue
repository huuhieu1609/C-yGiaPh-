                    ...
                    <form @submit.prevent="saveData">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control radius-8 border-2 shadow-none"
                                placeholder="Nhập tên dòng họ" v-model="formData.ten_chi" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control radius-8 border-2 shadow-none" rows="4"
                                placeholder="Nhập mô tả" v-model="formData.mo_ta"></textarea>
                        </div>
                ...
                <div class="card-body p-4">
                    <div class="input-group mb-4 radius-8 overflow-hidden border-2">
                        <input type="text" class="form-control border-0 shadow-none ps-4"
                            placeholder="Tìm kiếm chi nhánh..." v-model="searchQuery">

                        <button class="btn btn-success px-5 fw-bold" type="button"
                            style="background-color: #00c853; border-color: #00c853;">
                            Tìm kiếm
                        </button>
                    </div>
...
export default {
    ...
    computed: {
        filteredList() {
            ...
            return this.listData.filter(item =>
                item.ten_chi &&
                item.ten_chi.toLowerCase().includes(q)
            )
        }
    },
    ...
    methods: {
        ...
        loadData() {
            ...
            axios.get(
                'http://127.0.0.1:8000/api/chi-nhanh/get-data',
                this.getHeaders()
            )
                .then(res => {
                    if (res.data.status) {
