<template>
    <div class="su-kien-management-wrapper">
        <!-- Page Header -->
        <div class="page-header mb-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div class="d-flex align-items-center gap-3">
                <div class="page-icon">
                    <i class='bx bx-calendar-event' style="color: #0ea5e9;"></i>
                </div>
                <div>
                    <h4 class="mb-0 fw-bold theme-text-main page-title text-gradient-gold">Quản Lý Sự Kiện</h4>
                    <p class="mb-0 text-secondary small mt-1">Tổ chức các ngày giỗ tổ, gặp mặt dòng tộc, hoạt động từ thiện và hiếu hỷ</p>
                </div>
            </div>
            <div class="d-flex align-items-center gap-3">
        ...
        <div v-if="!selectedPartner" class="card shadow-sm border-0 radius-10 p-5 text-center bg-white">
            <div class="empty-state-icon mb-4">
                <i class="bx bx-calendar-event fs-1 text-warning opacity-75 animate__animated animate__pulse animate__infinite" style="font-size: 60px;"></i>
            </div>
            <h4 class="fw-bold text-dark mb-3">Chưa Chọn Đối Tác Quản Lý Sự Kiện</h4>
            <p class="text-muted small mx-auto mb-4" style="max-width: 480px; font-size: 14px; line-height: 1.6;">
                Vui lòng lựa chọn một tài khoản đối tác từ danh sách để tải danh sách sự kiện và thực hiện quản lý tương ứng.
            </p>
            <div>
                                ...
                                <tbody>
                                    ...
                                    <tr v-else-if="filteredList.length === 0">
                                        <td colspan="7" class="text-center py-5 text-muted">
                                            ...
                                            Chưa có sự kiện nào được tạo dựng cho dòng họ này
                                        </td>
                                    </tr>
