            ...
            <div class="card shadow-sm border-0 radius-10 h-100">
                <div class="card-header bg-white py-3 border-0 border-bottom">
                    <h5 class="mb-0 fw-bold text-uppercase" style="color: #00b4d8;">
                        <i class="bx bx-plus-circle me-1"></i> {{ isEditing ? 'Cập Nhật Đối Tác' : 'Đăng Ký Đối Tác Mới' }}
                    </h5>
                </div>
            ...
            <div class="card shadow-sm border-0 radius-10 h-100">
                <div class="card-header bg-white py-3 border-0 border-bottom d-flex align-items-center justify-content-between">
                    <h5 class="mb-0 fw-bold text-uppercase" style="color: #333;">
                        <i class="bx bx-list-ul me-1"></i> Danh Sách Đối Tác & Gói Dịch Vụ
                    </h5>
                </div>
                <div class="card-body p-4">
                    <div class="input-group mb-4 radius-8 overflow-hidden border-2">
                        <input type="text" class="form-control border-0 shadow-none ps-4" placeholder="Tìm kiếm theo tên đối tác hoặc gói..." v-model="searchQuery">
                        ...
                        <table class="table table-bordered table-hover align-middle mb-0">
                            <thead class="text-center text-white" style="background-color: #008bf8;">
                                <tr>
                                    ...
                                    <th width="20%" class="py-3">Đối Tác</th>
                                    <th width="20%" class="py-3">Tên Gói</th>
                                    <th width="15%" class="py-3">Số Tiền</th>
                                    <th width="25%" class="py-3">Thời Hạn Gói</th>
    ...
    computed: {
        filteredList() {
            ...
            return this.listData.filter(item => {
                ...
                return partnerName.includes(q) || partnerEmail.includes(q) || packageName.includes(q);
            });
        }
    },
    mounted() {
