          ...
          <div class="card-body p-4 p-md-5">
            <div class="row">
              ...
              <div class="col-md-4 text-center mb-4 mb-md-0 border-end">
                ...
                <span class="badge bg-light text-dark border mb-2">{{ getRoleDisplay(profile) }}</span>
...
export default {
  ...
  methods: {
    getRoleDisplay(user) {
      ...
      // Ưu tiên tên chức vụ (Quản Trị Viên, Trưởng Nhánh, ...) thay vì vai_tro database
      if (user.chuc_vu && user.chuc_vu.ten_chuc_vu) {
        return user.chuc_vu.ten_chuc_vu;
      }
      // Fallback: hiển thị vai_tro (Admin, Thành viên, ...)
      return user.vai_tro || 'Khách hàng';
    },
